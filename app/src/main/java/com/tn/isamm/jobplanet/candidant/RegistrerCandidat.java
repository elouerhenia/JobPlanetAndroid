...
import com.tn.isamm.jobplanet.RegisterActivity;
...
public class RegistrerCandidat extends AppCompatActivity implements View.OnClickListener {
    ...
    public class CreateUserTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Toast.makeText(RegistrerCandidat.this, "Account created", Toast.LENGTH_SHORT).show();
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (checkNetwork.isConnected(RegistrerCandidat.this) && success) {
                Toast.makeText(RegistrerCandidat.this, "Account created", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(RegistrerCandidat.this, "Network Error", Toast.LENGTH_SHORT).show();
            }
        }
    ...
    public void onBackPressed() {
        startActivity(new Intent(RegistrerCandidat.this, LoginActivity.class));
        finish();
    }
