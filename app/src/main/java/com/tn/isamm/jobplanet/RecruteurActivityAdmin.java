...
public class RecruteurActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isShowPageStart) {
            ...
            Glide.with(RecruteurActivityAdmin.this).load(R.drawable.ic_launcher_big).into(img_page_start);
