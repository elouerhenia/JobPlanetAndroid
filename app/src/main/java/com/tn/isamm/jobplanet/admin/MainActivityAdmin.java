...
import com.tn.isamm.jobplanet.CardsFragment;
import com.tn.isamm.jobplanet.FragmentAdapter;
import com.tn.isamm.jobplanet.R;
import com.tn.isamm.jobplanet.candidant.AllEntreprisesFragment;
...
public class MainActivityAdmin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isShowPageStart) {
            ...
            Glide.with(MainActivityAdmin.this).load(R.drawable.ic_launcher_big).into(img_page_start);
...
//        setSupportActionBar(toolbar);
    ...
    private void initViewPager() {
        ...
        fragments.add(new AdminAllEntreprisesFragment());
        fragments.add(new AdminAllCandidatFragment());

        //AdminAllCandidatFragment
